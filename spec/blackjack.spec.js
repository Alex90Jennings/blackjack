...
describe('blackjack', () => {
  ...
  it('set-up hand for two Players', () => {
    ...
    const score = blackjack.countScore([{ number: 8, suit: 'diamonds' }, { number: 4, suit: 'spades' }])
    ...
    const score = blackjack.countScore([{ number: 12, suit: 'diamonds' }, { number: 13, suit: 'spades' }])
    ...
    const score = blackjack.countScore([{ number: 14, suit: 'diamonds' }, { number: 14, suit: 'spades' }])
    ...
    const score = blackjack.countScore([{ number: 14, suit: 'diamonds' }, { number: 14, suit: 'spades' }, { number: 13, suit: 'spades' }, { number: 12, suit: 'spades' }, { number: 10, suit: 'spades' }])
    ...
    const playerHand = [{ number: 11, suit: 'diamonds' }, { number: 13, suit: 'spades' }]
  ...
  it('compare playerOne hand to Dealer hand to see who wins (dealer wins)', () => {
    const blackjack = new Blackjack()
    const dealerHand = [{ number: 11, suit: 'diamonds' }, { number: 13, suit: 'spades' }]
    const playerHand = [{ number: 6, suit: 'diamonds' }, { number: 12, suit: 'spades' }]
  ...
  it('compare playerOne hand to Dealer hand to see who wins (player goes bust)', () => {
    const blackjack = new Blackjack()
    const dealerHand = [{ number: 6, suit: 'diamonds' }, { number: 12, suit: 'spades' }]
    const playerHand = [{ number: 11, suit: 'diamonds' }, { number: 4, suit: 'spades' }, { number: 8, suit: 'spades' }]
  ...
  it('compare playerOne hand to Dealer hand to see who wins (dealer goes bust)', () => {
    const blackjack = new Blackjack()
    const dealerHand = [{ number: 11, suit: 'diamonds' }, { number: 4, suit: 'spades' }, { number: 8, suit: 'spades' }]
    const playerHand = [{ number: 6, suit: 'diamonds' }, { number: 12, suit: 'spades' }]
  ...
  it('compare playerOne hand to Dealer hand to see who wins (both go bust)', () => {
    const blackjack = new Blackjack()
    const dealerHand = [{ number: 11, suit: 'diamonds' }, { number: 4, suit: 'spades' }, { number: 8, suit: 'spades' }]
    const playerHand = [{ number: 11, suit: 'spades' }, { number: 4, suit: 'diamonds' }, { number: 8, suit: 'diamonds' }]
  ...
  it('player gets blackjack', () => {
    const blackjack = new Blackjack()
    const playerHand = [{ number: 14, suit: 'spades' }, { number: 11, suit: 'diamonds' }]
  ...
  it('player gets blackjack', () => {
    const blackjack = new Blackjack()
    const playerHand = [{ number: 14, suit: 'spades' }, { number: 5, suit: 'diamonds' }, { number: 5, suit: 'spades' }]
